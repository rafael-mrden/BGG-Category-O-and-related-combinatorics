...
# This file was *autogenerated* from the file E6_JM_chains.sage
...
JM_dict = load("JM_data/{}".format(CartanType(W)[_sage_const_0 ]+str(CartanType(W)[_sage_const_1 ])))
