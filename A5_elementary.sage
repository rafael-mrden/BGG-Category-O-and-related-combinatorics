...
for eq in elem:
    ...
    if KReq not in elem and list(reversed(KReq)) not in elem:
        elem.append(KReq)
        result +=  print_equation(KReq)
 
 

print("Done with elem.")
...
for eq in elem:
    if (len(eq[0]) > 2 or len(eq[1]) > 2):
        result += "We have a big relation:\n"
        result +=  print_equation(eq)   

text_file = open("Graded_characters_in_O_0_data/miscellaneous/A5 elementary isomorphisms and decompositions.txt", "w")
text_file.write(result)
text_file.close()

print("Saved A5 elementary isomorphisms and decompositions.txt")
print(datetime.datetime.now())

text_file = open("Graded_characters_in_O_0_data/miscellaneous/A5_elementary_isomorphisms_and_decompositions.txt", "w")
text_file.write(str(elem))
text_file.close()

print("Saved A5_elementary_isomorphisms_and_decompositions.txt")
print(datetime.datetime.now())
...
print("Started writing the result.")
print(datetime.datetime.now())
...
for comp in G_components:
    ...
    result2 += "{ " + " , ".join(["%s * %s" %(convert_to_123(p[1]),convert_to_123(p[0]))   for p in  comp ]) + " }:\n\n"
...
text_file = open("Graded_characters_in_O_0_data/miscellaneous/A5 elementary isomorphisms ala Johan.txt", "w")
text_file.write(result2)
text_file.close()

print("Saved A5 elementary isomorphisms ala Johan.txt")
print(datetime.datetime.now())